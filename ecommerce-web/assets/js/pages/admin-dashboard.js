...
function renderStats(counts) {
  ...
  grid.innerHTML = `
    ...
    <div class="stat-card${(counts.flagged_products || 0) > 0 ? " is-warm" : ""}">
    ...
    <div class="stat-card${(counts.open_complaints || 0) > 0 ? " is-alert" : ""}">
